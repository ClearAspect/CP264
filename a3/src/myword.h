...
/*
 * Define structure type WORD consists of char word[20] to store a word, int
 * count to hold frequency of the word.
 */
typedef struct {
	char word[20];
	int count;
...
/*
 * Define structure type WORDSTATS consisting of int line_count, int word_count,
 * and int keyword_count to represent to represent the number of lines, number
 * of all words, and the number of different non-common-word in text data.
 */
typedef struct {
	int line_count;
	int word_count;
