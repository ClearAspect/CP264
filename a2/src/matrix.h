/*
 * Compute and return the norm of vector v, namely, the square root of the sum
 * of squares of elements of v.
 *
...
/*
 * Compute and return the dot product of vectors v1[n] and v2[n], namely the sum
 * of product of corresponding elements of v1 and v2.
 *
